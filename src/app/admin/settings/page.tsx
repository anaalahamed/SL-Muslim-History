          ...
          >
            ...
            <div className="p-6 space-y-5">
              {([
                ...
                {
                  key: 'twitter', label: 'X', placeholder: 'https://x.com/yourhandle', color: '#000000',
