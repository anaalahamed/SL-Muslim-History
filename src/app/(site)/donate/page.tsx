...
const BANKS = [
  {
    name: 'Bank of Ceylon',
    accountName: 'SL Muslim History Foundation',
  ...
  return (
    <main>
      ...
      <section
        ...
        style={{
          background: 'linear-gradient(135deg, #0d3b1a 0%, #1a5c2a 50%, #0d3b1a 100%)',
      ...
      >
        ...
        <div
          ...
          style={{ background: '#4a9e1f', filter: 'blur(40px)' }}
        />
      ...
      <section style={{ background: '#f8fafc', padding: '0 24px 80px' }}>
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: '#b45309' }}>
                ...
                We will notify subscribers as soon as online donations go live.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            {/* ── Left: Amount selector + payment options ── */}
            <div className="lg:col-span-3 space-y-6">

              {/* Amount selector */}
              <div
                className="rounded-2xl p-6"
                style={{ background: 'white', border: '1px solid #e2e8f0', boxShadow: '0 2px 12px rgba(0,0,0,0.05)' }}
              >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-4">
                  {AMOUNTS.map((amt) => (
                    <button
                      ...
                      style={{
                        background: selected === amt ? '#4a9e1f' : '#f8fafc',
                        color:      selected === amt ? 'white'   : '#475569',
                        border:     selected === amt ? '2px solid #3d8a18' : '2px solid #e2e8f0',
                        boxShadow:  selected === amt ? '0 4px 12px rgba(74,158,31,0.25)' : 'none',
                      }}
                    >
                ...
                <div
                  ...
                  style={{
                    border: `2px solid ${selected === null && custom ? '#4a9e1f' : '#e2e8f0'}`,
                    background: '#f8fafc',
                  }}
                >
                ...
                {displayAmount > 0 && (
                  <p className="text-xs mt-3 font-semibold" style={{ color: '#4a9e1f' }}>
                    ✓ You will donate LKR {displayAmount.toLocaleString()}
                  </p>
                )}
              </div>
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs mb-3" style={{ color: '#64748b' }}>
                    Transfer directly to our bank account and send the receipt to{' '}
                    <a href="mailto:donate@slmuslimhistory.lk" style={{ color: '#4a9e1f', fontWeight: 600 }}>
                      donate@slmuslimhistory.lk
                    </a>
                  </p>
                </div>
                ...
                <div className="mb-4 relative">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xl">💳</span>
                    <span className="font-bold text-sm" style={{ color: '#0f172a' }}>PayPal / Credit Card</span>
                    <span
                      className="text-xs font-bold px-2 py-0.5 rounded-full"
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-xl">📱</span>
                    <span className="font-bold text-sm" style={{ color: '#0f172a' }}>PayHere (Sri Lanka)</span>
                    <span
                      className="text-xs font-bold px-2 py-0.5 rounded-full"
                      style={{ background: '#fef9c3', color: '#a16207' }}
                    >
                  ...
                  <button
                    ...
                    style={{ background: '#e2e8f0', color: '#94a3b8' }}
                  >
                    Donate via PayHere — Coming Soon
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
                      ...
                      <div key={key} className="flex items-center justify-between py-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            style={{
                              background: copied === key ? '#dcfce7' : '#f1f5f9',
                              color: copied === key ? '#15803d' : '#64748b',
                            }}
                          >
                            {copied === key ? '✓' : '⧉'}
                          </button>
              ...
              >
                ...
                <p className="text-xs mb-3" style={{ color: '#166534' }}>
                  We&apos;re happy to answer any questions about donations.
                </p>
                <Link
                  href="/contact"
