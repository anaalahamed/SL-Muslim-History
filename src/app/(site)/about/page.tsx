      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 space-y-20">
        ...
        <AnimateIn direction="up">
          ...
          >
            ...
            <h2 className="text-2xl font-extrabold mb-3" style={{ color: 'var(--dark)' }}>
              Want to Contribute?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                ...
                style={{
                  ...
                  color: 'white',
                  boxShadow: '0 4px 14px rgba(74,158,31,0.3)',
                  transition: 'transform 0.2s ease, box-shadow 0.2s ease',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-2px)'
                  e.currentTarget.style.boxShadow = '0 8px 20px rgba(74,158,31,0.4)'
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)'
                  e.currentTarget.style.boxShadow = '0 4px 14px rgba(74,158,31,0.3)'
                }}
              >
                Get in Touch →
              </Link>
