...
const staticPages: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/news/special`,       lastModified: new Date(), changeFrequency: 'daily',   priority: 0.8 },
  { url: `${BASE}/news/janaza`,        lastModified: new Date(), changeFrequency: 'daily',   priority: 0.8 },
