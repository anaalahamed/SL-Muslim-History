              ...
              >
                ...
                <div className="art-card-body" style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Noto Sans Tamil','Lato',sans-serif", fontSize: '12.5px', fontWeight: 700, lineHeight: 1.5, color: 'var(--dark)', transition: 'color .2s', overflowWrap: 'anywhere' }}
                  >
                    {article.title}
                  </p>
                  {preview && (
                    <p className="art-excerpt line-clamp-1 sm:line-clamp-2 md:line-clamp-3" style={{ fontFamily: "'Noto Sans Tamil','Lato',sans-serif", fontSize: '11px', color: 'var(--muted)', lineHeight: 1.55, overflowWrap: 'anywhere' }}>
                      {preview}
                    </p>
                  )}
